...
public class DoctorController {
	...
	public Doctor addDoctor(@RequestBody Doctor doctor) throws DoctorException, ValidateDoctorException, ValidateUserException, UserException {
	...
	public Doctor removeDoctor(@PathVariable("doctorId") Doctor doctor) throws DoctorException {
